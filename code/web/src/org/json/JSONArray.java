  ...
  implements Iterable<Object>
{
    ...
    throws JSONException
  {
    ...
    try {
      return (object instanceof Number) ? ((Number)object).doubleValue() : 
        Double.parseDouble((String)object); } catch (Exception e) {
    }
    ...
    throws JSONException
  {
    Object object = get(index);
    try {
      return new BigDecimal(object.toString()); } catch (Exception e) {
    }
    ...
    throws JSONException
  {
    Object object = get(index);
    try {
      return new BigInteger(object.toString()); } catch (Exception e) {
    }
    throw new JSONException("JSONArray[" + index + 
    ...
    throws JSONException
  {
    ...
    try {
      return (object instanceof Number) ? ((Number)object).intValue() : 
        Integer.parseInt((String)object); } catch (Exception e) {
    }
    throw new JSONException("JSONArray[" + index + "] is not a number.");
  }
    ...
    throws JSONException
  {
    ...
    try {
      return (object instanceof Number) ? ((Number)object).longValue() : 
        Long.parseLong((String)object); } catch (Exception e) {
    }
    throw new JSONException("JSONArray[" + index + "] is not a number.");
  }
  ...
  public <E extends Enum<E>> E optEnum(Class<E> clazz, int index, E defaultValue)
  {
    try
    {
      ...
      return defaultValue; } catch (NullPointerException e) {
    }
    return defaultValue;
  }
  ...
  public BigInteger optBigInteger(int index, BigInteger defaultValue)
  {
    try
    {
      return getBigInteger(index); } catch (Exception e) {
    }
    return defaultValue;
  }
  ...
  public BigDecimal optBigDecimal(int index, BigDecimal defaultValue)
  {
    try
    {
      return getBigDecimal(index); } catch (Exception e) {
    }
    return defaultValue;
  }
  ...
  public Object optQuery(String jsonPointer)
  {
    ...
    try {
      return pointer.queryFrom(this); } catch (JSONPointerException e) {
    }
    return null;
  }
  ...
  public String toString()
  {
    try
    {
      return toString(0); } catch (Exception e) {
    }
    return null;
  }
  ...
  public List<Object> toList()
  {
    ...
    for (Iterator localIterator = this.myArrayList.iterator(); localIterator.hasNext(); ) { Object element = localIterator.next();
